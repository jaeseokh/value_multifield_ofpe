...
```{r compare} 
#| label: compare
etable(m0, m0_legacy, m1, m2, m3, se = "cluster",
dict = c(zN="N (z)", zN2="N^2 (z)",
"zN"="N×postN15", "zN2"="N^2×postN15",
"zN"="N×GDD_S2", "zN2"="N^2×GDD_S2"),
keep = "^(zN|zN2|zWS|zSLP|zTPI|zCL|zSA|zSI|zELV|zASP|:)"
)
